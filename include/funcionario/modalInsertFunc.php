<div class="modal fade" id="modalInsertFunc" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-header bg-success">
        ...
        <form method="post">
            ...
            <div class="modal-footer">
                <input type="submit" class="btn btn-success mb-3" name="cadFunc" data-bs-toggle="modal" data-bs-target="#exampleModal" value="Cadastrar">
            </div>
        </form>
    </div>
  </div>
